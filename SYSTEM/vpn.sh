...
# ==================================================
# Link Hosting Kalian
HOKAGE="https://raw.githubusercontent.com/BangJali05/Store/refs/heads/main/SYSTEM/"
...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/BangJali05/Store/refs/heads/main/SYSTEM/vpn.zip
unzip vpn.zip
rm -f vpn.zip
